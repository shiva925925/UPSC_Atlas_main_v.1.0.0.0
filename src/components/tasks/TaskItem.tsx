...
const TaskItem: React.FC<TaskItemProps> = ({
    ...
    return (
        <div
            ...
            className={`grid grid-cols-12 gap-4 px-6 py-4 border-b border-gray-100 items-center hover:bg-blue-50/50 cursor-pointer transition-colors group ${isSelected ? 'bg-blue-50' : ''}`}
        >
            {/* Task Title & Progress */}
